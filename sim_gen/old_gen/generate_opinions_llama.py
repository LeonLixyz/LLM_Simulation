...
def load_persona(state, index):
    file_path = f"/user/al4263/Simulate/Persona/Persona_Llama_Based/{state.abbr}/{state.abbr}_persona_{index}.json"
...
def main():
    ...
    for topic_index in range(topic_start_index, len(generate_topics(data))):
        ...
        output_dir = f"/user/al4263/Simulate/Simulations/Election/{Topic}/Persona_Llama_Based"
