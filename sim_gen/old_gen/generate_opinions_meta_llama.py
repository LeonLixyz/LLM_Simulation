...
def generate_topics(topic_data):
    ...
    for subtopic, data in topic_data.items():
        ...
        with open("Prompts/opinion_simulation/user_instruction.json", "r") as f:
...
def load_persona_meta(state, index):
    file_path = f"/shared/share_mala/Leon/LLM_Sim/Persona/Persona_Meta_Based/{state.abbr}/{state.abbr}_persona_{index}.json"
...
def main():
    ...
    with open("/user/al4263/Simulate/Prompts/opinion_simulation/system_instruction.json", "r") as f:
    ...
    for topic_index in range(topic_start_index, len(generate_topics(data))):
        ...
        output_dir = f"/user/al4263/Simulate/Simulations/Election/{Topic}/Persona_Meta_Based"
